            ...
            <Container className="py-2">
                ...
                <Navbar.Collapse id="basic-navbar-nav">
                    <Nav className="me-auto d-flex align-items-center">
                        ...
                        {!isAuth &&
                            <Nav.Link href="/account"><Button>Information</Button></Nav.Link>
                        }
                    </Nav>
                </Navbar.Collapse>
                <Navbar.Collapse className="justify-content-end">
                    <Nav>
                        {!isAuth ?
                            ...
                            <Stack direction="horizontal" gap={2} className="m-auto">
                                <DropdownButton title={<FontAwesomeIcon icon={faUser} fontSize={25}/>}  drop="down-centered" variant="secondary" >
